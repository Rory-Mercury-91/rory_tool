...
def show_tutorial():
    ...
    create_section(scrollable_frame, theme, "🎯 Vue d'ensemble", [
        "Le Traducteur Ren'Py Pro v2.4.4 est un outil spécialisé pour les traductions de jeux Ren'Py.",
    ...
    # Section 3: Nouveautés v2.4.4
    create_section(scrollable_frame, theme, "🆕 Nouveautés v2.4.4", [
    ...
    log_message("INFO", "Tutoriel v2.4.4 affiché (non-bloquant)")
...
def show_quick_help(parent, topic=None):
    ...
    help_topics = {
        ...
        'files': {
            ...
            'subtitle': "Structure organisée par jeu v2.4.4",
            'sections': [
                ("📂 Arborescence", [
...
def show_minimal_tutorial():
    ...
    # Section Important
    create_section(scrollable_frame, theme, "⚠️ Important v2.4.4", [
    ...
    log_message("INFO", "Guide Express v2.4.4 affiché avec style harmonisé")
...
def show_whats_new():
    ...
    # Section Interface
    create_section(scrollable_frame, theme, "🎨 Interface v2.4.4", [
    ...
    # Section Utilisation
    create_section(scrollable_frame, theme, "💡 Utilisation optimale v2.4.4", [
    ...
    log_message("INFO", "Nouveautés v2.4.4 affichées avec style harmonisé")

def create_tutorial_menu():
    """Crée un menu contextuel pour différents types d'aide"""
    def show_menu():
        menu_window = tk.Toplevel()
        menu_window.title("🎓 Centre d'aide v2.4.4")
        ...
        buttons = [
            ("📖 Guide complet v2.4.4", "Guide détaillé avec toutes les fonctionnalités actuelles", show_tutorial),
            ("⚡ Guide express", "Version rapide pour utilisateurs expérimentés", show_minimal_tutorial),
            ("🆕 Nouveautés v2.4.4", "Découvrir les améliorations et nouvelles fonctions", show_whats_new),
            ...
            ("📁 Organisation fichiers", "Structure organisée par jeu v2.4.4", lambda: show_quick_help(None, 'files'))
        ]
