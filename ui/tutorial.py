...
def show_tutorial():
    ...
    create_section(scrollable_frame, theme, "🎯 Vue d'ensemble", [
        "Le Traducteur Ren'Py Pro v2.3.0 est un outil spécialisé pour les traductions de jeux Ren'Py.",
    ...
    # Section 3: Nouveautés v2.3.0
    create_section(scrollable_frame, theme, "🆕 Nouveautés v2.3.0", [
    ...
    log_message("INFO", "Tutoriel v2.3.0 affiché (non-bloquant)")
...
def show_quick_help(parent, topic=None):
    ...
    help_topics = {
        ...
        'files': {
            ...
            'subtitle': "Structure organisée par jeu v2.3.0",
            'sections': [
                ("📂 Arborescence", [
...
def show_minimal_tutorial():
    ...
    # Section Important
    create_section(scrollable_frame, theme, "⚠️ Important v2.3.0", [
    ...
    log_message("INFO", "Guide Express v2.3.0 affiché avec style harmonisé")
...
def show_whats_new():
    ...
    # Section Interface
    create_section(scrollable_frame, theme, "🎨 Interface v2.3.0", [
    ...
    # Section Utilisation
    create_section(scrollable_frame, theme, "💡 Utilisation optimale v2.3.0", [
    ...
    log_message("INFO", "Nouveautés v2.3.0 affichées avec style harmonisé")

def create_tutorial_menu():
    """Crée un menu contextuel pour différents types d'aide"""
    def show_menu():
        menu_window = tk.Toplevel()
        menu_window.title("🎓 Centre d'aide v2.3.0")
        ...
        buttons = [
            ("📖 Guide complet v2.3.0", "Guide détaillé avec toutes les fonctionnalités actuelles", show_tutorial),
            ("⚡ Guide express", "Version rapide pour utilisateurs expérimentés", show_minimal_tutorial),
            ("🆕 Nouveautés v2.3.0", "Découvrir les améliorations et nouvelles fonctions", show_whats_new),
            ...
            ("📁 Organisation fichiers", "Structure organisée par jeu v2.3.0", lambda: show_quick_help(None, 'files'))
        ]
